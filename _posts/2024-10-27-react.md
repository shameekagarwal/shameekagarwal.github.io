...
- [eslint exhaustive deps](#eslint-exhaustive-deps) will help point this out to us, and we can thus fix it as follows - 
  ```jsx
  useEffect(() => {
    document.body.addEventListener("click", () => {
      console.log(counter);
...
- we saw in [stale variable reference](#stale-variable-reference) how this eslint check helped us
